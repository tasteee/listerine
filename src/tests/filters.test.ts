...
describe('more filter assurances', () => {
  it('$is', () => {
    {
      const id$ = { $is: '0' }
      const query = { id$ }
      const results = listerine(DATA1).query(query)
      const expected = [DATA1[0]]
  ...
  it('$isNot', () => {
    {
      ...
      const query = { id$ }
      const results = listerine(DATA1).query(query)
      const expected = [DATA1[1], DATA1[2]]
      expect(results.data).toEqual(expected)
    }

    {
      ...
      const query = { id$ }
      const results = listerine(DATA1).query(query)
      const expected = [DATA1[0], DATA1[1], DATA1[2]]
      expect(results.data).toEqual(expected)
    }
  })
  ...
  it('$isIn', () => {
    {
      ...
      const query = { id$ }
      const results = listerine(DATA1).query(query)
      const expected = [DATA1[0], DATA1[2]]
      expect(results.data).toEqual(expected)
    }
...

    {
      ...
      const query = { name$ }
      const results = listerine(DATA1).query(query)
      const expected: typeof DATA1 = [DATA1[1]]
      expect(results.data).toEqual(expected)
    }

    {
      ...
      const query = { tags$ }
      const results = listerine(DATA1).query(query)
      const expected: typeof DATA1 = [DATA1[0]]
      expect(results.data).toEqual(expected)
    }
  })
  ...
  it('$isNotOneOf', () => {
...

    {
      ...
      const query = { id$ }
      const results = listerine(DATA1).query(query)
      const expected: typeof DATA1 = [DATA1[0], DATA1[1], DATA1[2]]
      expect(results.data).toEqual(expected)
    }
  })
  ...
  it('$isGreaterThan', () => {
    {
      ...
      const query = { age$ }
      const results = listerine(DATA1).query(query)
      const expected: typeof DATA1 = [DATA1[0], DATA1[2]]
      expect(results.data).toEqual(expected)
    }
  ...
  it('$isGreaterThanOrEqualTo', () => {
...

    {
      ...
      const query = { age$ }
      const results = listerine(DATA1).query(query)
      const expected: typeof DATA1 = [DATA1[2]]
      expect(results.data).toEqual(expected)
    }
  })
  ...
  it('$isLessThanOrEqualTo', () => {
    {
      ...
      const query = { age$ }
      const results = listerine(DATA1).query(query)
      const expected: typeof DATA1 = [DATA1[0], DATA1[1]]
      expect(results.data).toEqual(expected)
    }
  ...
  it('should handle complex queries', () => {
    {
      ...
      const result0 = listerine(DATA1).query(query)
      const expected0 = [DATA1[0]]
